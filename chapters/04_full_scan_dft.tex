...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_45.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_17.png}
    \caption{\textit{Chèn Scan (Scan insertion)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_18.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_19.png}
    \caption{\textit{Chốt cơ bản (Basic latch)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_20.png}
    \caption{\textit{Chốt loại D (D-latch)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_21.png}
    \caption{\textit{Chốt CMOS (CMOS latches)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_22.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_23.png}
    \caption{\textit{Phần tử quét dồn kênh (Multiplexed scan element)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_24.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_26.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_28.png}
    \caption{\textit{Flip-flop hai cổng ba xung nhịp}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_29.png}
    \caption{\textit{Định thời flip-flop hai cổng}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_31.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_34.png}
    \caption{\textit{Netlist residue5 sau tổng hợp (Postsynthesis)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_35.png}
    \caption{\textit{Netlist residue5 trải phẳng (Unfolded)}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_36.png}
    \caption{\textit{Chèn chuỗi quét (Scan chain) cho residue5}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_40.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fig7_42.png}
